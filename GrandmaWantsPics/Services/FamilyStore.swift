...
class FamilyStore: ObservableObject {
    ...
    func sendPhotos(imageDataList: [Data]) async throws { fatalError("Subclass must implement") }
    ...
    func saveFCMToken(_ token: String) async throws { fatalError("Subclass must implement") }
    func startListening() {}
    func stopListening() {}
}
